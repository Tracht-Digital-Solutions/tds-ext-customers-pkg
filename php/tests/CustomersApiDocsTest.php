 ...
 */
final class CustomersApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new CustomersModule()]);
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new CustomersModule())->permissions(),
        );

        foreach ((new CustomersModule())->apiDocs() as $doc) {
